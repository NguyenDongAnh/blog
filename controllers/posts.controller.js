...
const createPost = (req, res) => {
	try {
		let post = new Post({
			title: 'react-markdown Readme.md',
...
`,
			...
			tags: [
				ObjectID('62776f4d40fab92b9477e980'),
				ObjectID('62776f6740fab92b9477e981')
			]
		})
...
const findManyPostInSlugArray = async (req, res) => {
	try {
		let posts = await Post.find({ slug: { $in: req.body.storedPostList } })
			.populate('owner')
			.exec()
