	...
	return (
		<div className={styles.nav_search}>
			...
			<div className={styles.nav_search_item}>
				<input
					className={styles.nav_search_item__input}
					placeholder="Search"
					onChange={e => handleSearchChange(e, fuzzySearchValues)}
				/>
				...
				{searchResults.map(result => {
					return (
						<Link href="/" key={result.refIndex}>
							<a href="/">
								<div
									className={styles.nav_search_result_element}
								>
									<div>
			...
			>
				<div className={styles.nav_content}>
					<div className={styles.nav_header}>
						{isSm && (
							<div
								className={styles.nav_menu__button}
					...
					<div className="flex">
						<div
							className={classNames(
								styles.nav_main,
								isLeftSidebarActive
									? classNames(styles.active, 'z-[101]')
									: null
							)}
						>
							{isSm && (
						...
						{isSm && (
							<div
								className={classNames(
									'overlay',
									isLeftSidebarActive ? 'active' : null
								)}
								onClick={handleMenuButtonOnClick}
							></div>
						)}
